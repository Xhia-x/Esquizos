...
.video {
    ...
    min-width: 100%;
    min-height: 100%;
    z-index: -100; /* Para que el video esté detrás */
    object-fit: cover; /* Para que el video cubra toda la pantalla */
    pointer-events: none; /* Evita que el video interfiera con los clics o interacciones */
}
      ...
      <div class="side top-side">
        ...
        <div class="property-top">
            <Casilla 
                ...
                title="Estación" 
                price="200" 
                image="Esquizos\Esquizos\src\assets\TrenM.webp"
            />
        </div>
